...
#(c)opy@right > github.com/specialbot
#  #mekanık_mech
system ("title by mekanık_mech");
...
}elsif($nanii =~/Hacked by|defaced|anonymous|mekanık_mech|HaCKeD/) { #zidha Jaabdinja3bassa :v
print color('bold yellow')," [";
...
if ($^O =~ /MSWin32/) {system("cls"); }else { system("clear"); }
print q( 
~> Th3 Coder > mekanık_mech
From ? > REYHANLI 
instagram >instagram.com/mekanık_mech
Github > github.com/borahan951
